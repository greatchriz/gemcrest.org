            ...
            <nav class="navbar navbar-expand-lg classic transparent position-absolute navbar-dark">
              <div class="container flex-lg-row flex-nowrap align-items-center">
                <div class="navbar-brand w-100">
                  <a href="index.html">
                    <img class="logo-dark" src="assets/img/logo-dark.svg" width="180px" height="50px" alt="">
                    <!-- <img class="logo-light" src="assets/img/logo-light.png" srcset="assets/img/logo-light%402x.png 2x" alt=""> -->
                    <img class="logo-light" src="assets/img/logo-light.svg" width="180px" height="50px" alt="">
                  </a>
                </div>
                <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
                  ...
                  <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
                            ...
                            <ul class="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-4 gy-lg-2 list-unstyled">
                              <li class="col">
                                <a class="dropdown-item" href="demo1.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi1.jpg" srcset="assets/img/demos/mi1%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 1</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo2.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi2.jpg" srcset="assets/img/demos/mi2%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 2</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo3.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi3.jpg" srcset="assets/img/demos/mi3%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 3</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo4.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi4.jpg" srcset="assets/img/demos/mi4%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 4</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo5.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi5.jpg" srcset="assets/img/demos/mi5%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 5</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo6.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi6.jpg" srcset="assets/img/demos/mi6%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 6</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo7.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi7.jpg" srcset="assets/img/demos/mi7%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 7</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo8.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi8.jpg" srcset="assets/img/demos/mi8%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 8</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo9.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi9.jpg" srcset="assets/img/demos/mi9%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 9</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo10.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi10.jpg" srcset="assets/img/demos/mi10%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 10</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo11.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi11.jpg" srcset="assets/img/demos/mi11%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 11</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo12.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi12.jpg" srcset="assets/img/demos/mi12%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 12</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo13.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi13.jpg" srcset="assets/img/demos/mi13%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 13</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo14.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi14.jpg" srcset="assets/img/demos/mi14%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 14</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo15.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi15.jpg" srcset="assets/img/demos/mi15%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 15</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo16.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi16.jpg" srcset="assets/img/demos/mi16%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 16</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo17.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi17.jpg" srcset="assets/img/demos/mi17%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 17</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo18.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi18.jpg" srcset="assets/img/demos/mi18%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 18</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo19.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi19.jpg" srcset="assets/img/demos/mi19%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 19</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo20.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi20.jpg" srcset="assets/img/demos/mi20%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 20</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo21.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi21.jpg" srcset="assets/img/demos/mi21%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 21</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo22.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi22.jpg" srcset="assets/img/demos/mi22%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 22</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo23.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi23.jpg" srcset="assets/img/demos/mi23%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 23</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo24.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi24.jpg" srcset="assets/img/demos/mi24%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 24</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo25.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi25.jpg" srcset="assets/img/demos/mi25%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 25</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo26.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi26.jpg" srcset="assets/img/demos/mi26%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 26</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo27.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi27.jpg" srcset="assets/img/demos/mi27%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 27</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo28.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi28.jpg" srcset="assets/img/demos/mi28%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 28</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo29.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi29.jpg" srcset="assets/img/demos/mi29%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 29</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo30.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi30.jpg" srcset="assets/img/demos/mi30%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 30</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo31.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi31.jpg" srcset="assets/img/demos/mi31%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 31</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo32.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi32.jpg" srcset="assets/img/demos/mi32%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 32</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo33.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi33.jpg" srcset="assets/img/demos/mi33%402x.jpg 2x" alt=""></figure>
                                  <span class="d-lg-none">Demo 33</span>
                                </a>
                              </li>
                              <li class="col">
                                <a class="dropdown-item" href="demo34.html">
                                  <figure class="rounded lift d-none d-lg-block"><img src="assets/img/demos/mi34.jpg" srcset="assets/img/demos/mi34%402x.jpg 2x" alt=""></figure>
                    ...
                    <div class="offcanvas-footer d-lg-none">
                      <div>
                        <a href="cdn-cgi/l/email-protection.html#e5838c979691cb89849691a58088848c89cb868a88" class="link-inverse"><span class="__cf_email__" data-cfemail="0861666e67486d65696164266b6765">[email&#160;protected]</span></a>
            ...
            <div class="offcanvas offcanvas-end text-inverse" id="offcanvas-info" data-bs-scroll="true">
              ...
              <div class="offcanvas-body pb-6">
                ...
                <div class="widget mb-8">
                  ...
                  <a href="cdn-cgi/l/email-protection.html#7f19160d0c0b51131e0c0b3f1a121e1613511c1012"><span class="__cf_email__" data-cfemail="8ce5e2eae3cce9e1ede5e0a2efe3e1">[email&#160;protected]</span></a><br> 00 (123) 456 78 90
                </div>
                <!-- /.widget -->
                <div class="widget mb-8">
