        ...
        <ul class="nav nav-sm">
          ...
          <li class="nav-item">
            <a
              ...
              href="#region"
              class="nav-link"
            ><em class="icon ni ni-globe"></em><span class="ms-1">Select Region</span></a>
          </li>
        </ul>
      </div>
    </div>
          ...
          <ul class="country-list text-center gy-2">
            ...
            <li>
              ...
              ><img
                  ...
                  alt=""
                  class="country-flag"
                /><span class="country-name">Canada <small>(English)</small></span></a>
            </li>
            <li>
              <a
                href="#"
...
<ul class="nk-sticky-toolbar">
  <li class="demo-layout">
    ...
    ><em class="icon ni ni-dashlite"></em></a>
  </li>
  <li class="demo-thumb">
    <a
      class="toggle tipinfo"
    ...
    ><em class="icon ni ni-menu-squared"></em></a>
  </li>
  <li class="demo-settings">
    <a
      ...
      href="#"
      title="Demo Settings"
    ><em class="icon ni ni-setting-alt"></em></a>
  </li>
  ...
  >
    ...
    <div class="nk-demo-item">
      <a href="https://dashlite.net/demo2/lms/index.html">
        ...
        <span class="nk-demo-title"><em class="text-primary">Demo2</em><br /><strong>LMS / Learning Management
            System</strong></span>
      </a>
    </div>
    <div class="nk-demo-item">
      <a href="https://dashlite.net/demo1/crm/index.html">
        ...
        <span class="nk-demo-title"><em class="text-primary">Demo1</em><br /><strong>CRM / Customer Relationship
    ...
    <div class="nk-demo-item">
      <a href="https://dashlite.net/demo1/hotel/index.html">
        ...
        <span class="nk-demo-title"><em class="text-primary">Demo1</em><br /><strong>Hotel Management</strong></span>
      </a>
    </div>
    <div class="nk-demo-item">
  ...
  >
    ...
    <div class="nk-opt-set">
      ...
      <div class="nk-opt-list col-2x">
        ...
        >
          <span class="nk-opt-item-bg"><span class="theme-dark"></span></span><span class="nk-opt-item-name">Dark
            Skin</span>
        </div>
      </div>
    </div>
...
>
  <div class="pmo-st-img">
    <img
      src="../dashlite/images/landing/promo-investorm.png"
      alt="Investorm"
    />
  </div>
